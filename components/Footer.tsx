    ...
    <div className="relative z-50 rounded-xl border border-border/30 bg-white/60 dark:bg-slate-900/60 backdrop-blur-md shadow-sm p-1 sm:p-0.5">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4 max-w-screen-2xl mx-auto px-2 py-1.5 sm:py-2">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 text-white/80 text-xs sm:text-sm">
          <span className="text-[10px] sm:text-sm">Word Agents © 2025</span>
          <span className="hidden sm:inline">•</span>
          <span className="flex items-center gap-1">
            <span className="text-[10px] sm:text-sm">Made with</span> <Heart className="h-2.5 w-2.5 sm:h-3.5 sm:w-3.5 text-red-400 fill-red-400" />
          </span>
        </div>
